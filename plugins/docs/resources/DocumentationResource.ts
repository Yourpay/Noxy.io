...
export default class DocumentationResource extends Resource.Constructor {
  ...
  constructor(initializer: tNonFnPropsOptional<DocumentationResource> = {}) {
    super(initializer);
...
Resource<eDocumentationType>(eDocumentationType.DOCUMENTATION_RESOURCE, DocumentationResource, definition, options);
