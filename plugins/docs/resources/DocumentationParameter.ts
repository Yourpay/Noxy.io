...
export default class DocumentationParameter extends Resources.Constructor {
  
  public static readonly __type: string = "documentation/parameter";
  public static readonly __table: Table = new Table(DocumentationParameter, options, columns);
