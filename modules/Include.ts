...
export function Include(dir_path: string): Promise<{[key: string]: string}>
export function Include(options: iIncludeOptions & {sync: true}): {[key: string]: string}
export function Include(options: iIncludeOptions): Promise<{[key: string]: string}>
export function Include(path_or_options: string | iIncludeOptions): Promise<{[key: string]: string}> | {[key: string]: string} {
...
export namespace Include {
  export function async(options: iIncludeOptions): Promise<{[key: string]: string}> {
