...
//     private readonly __endpoints: {[endpoint: string]: {[method: string]: Middleware[]}};
//     private readonly __params: {[param: string]: Middleware};
//
...
//     }
//
//     public get endpoints(): {[endpoint: string]: {[method: string]: Middleware[]}} {
//       return _.clone(this.__endpoints);
//     }
//
//     public get params(): {[param: string]: Middleware} {
//       return _.clone(this.__params);
//     }
//
//     public param(param: string, handler: Middleware) {
//       if (!this.__params[param]) { this.__params[param] = handler; }
//       return this;
//     }
//
//     public endpoint(method: Method, endpoint: string, ...middlewares: Middleware[]): this {
